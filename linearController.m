...
% Working
    ...
    % Klqr = lqr([0, 1, Vx, 0; ...
    %             0, -(Cf + Cr) / (m * Vx), 0, -Vx - (Cf * lf + Cr * lr) / (m * Vx); ...
    %             0, 0, 0, 1; ...
    %             0, -(Cf * lf - Cr * lr) / (I * Vx), 0, -(Cf * lf^2 + Cr * lr^2) / (I * Vx)], ...
    %            [0; ...
    %             Cf/m; ...
    %             0; ...
    %             Cf * lf / I], ...
    ...
    Klqr = [3.16227766016839, 0.289293363059341, 6.58494480351886, -0.0174032802330504];
